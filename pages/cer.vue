<template>
    <div class="container privacy-content" style="padding: 50px 0px">
        <h1 class="pr-title">Политика конфиденциальности</h1>
        <p><br /></p>
        <p>1. Общие положения</p>
        <p>
            Настоящая политика обработки персональных данных составлена в
            соответствии с требованиями Закон Республики Узбекистан, от
            02.07.2019 г. № ЗРУ-547&laquo;О персональных данных&raquo; (далее -
            ...
            данных, предпринимаемые Азам Абдуганиев Батырович (далее &ndash;
            Оператор).
        </p>
        <p>
        ...
        <p>
            ...
            данных (далее &ndash; Политика) применяется ко всей информации,
            которую Оператор может получить о посетителях веб-сайта
            <a data-fr-linked="true" href="https://www.amediatv.uz/"
                >https://www.amediatv.uz/</a
            >
        </p>
        ...
        <p>
            2.2. Блокирование персональных данных &ndash; временное прекращение
        ...
        <p>
            2.6. Обработка персональных данных &ndash; любое действие (операция)
        ...
        <p>
            2.8. Персональные данные &ndash; любая информация, относящаяся прямо
        ...
        <p>
            &ndash; самостоятельно определять состав и перечень мер, необходимых
        ...
        <p>
            ...
            установленном действующим законодательством Республики Узбекистан;
        </p>
        <p>
        ...
        <p>
            &ndash; требовать от оператора уточнения его персональных данных, их
        ...
        <p>
            5.4. Также на сайте происходит сбор и обработка обезличенных данных
        ...
        <p>
            ...
            если иное не предусмотрено законом Республики Узбекистан.
        </p>
        <p>7. Цели обработки персональных данных</p>
        <p>7.1. Цель обработки персональных данных Пользователя:</p>
        <p>
            &ndash; информирование Пользователя посредством отправки электронных
            писем или с помощью смс
        </p>
        <p>
        ...
        <p>
            &ndash; предоставление доступа Пользователю к сервисам, информации
            и/или материалам, содержащимся на веб-сайте или приложения
            httpsː//Amediatv.uz&nbsp;
        </p>
        <p>
            ...
            электронной почты
            <a data-fr-linked="true" href="mailto:Aniblauz@gmail.com"
                >Aniblauz@gmail.com</a
            >
            с пометкой &laquo;Отказ от уведомлений о новых продуктах и услугах и
        ...
        <p>
            &ndash; перечислите нормативно-правовые акты, регулирующие
            ...
            созданием сайтов, то здесь можно указать &quot;Об информации,
            информационных технологиях и о защите информации&quot; Закон
            Республики Узбекистан от 11.12.2003 г. N 560-II
        </p>
        ...
        <p>
            ...
            предусмотренных международным договором Республики Узбекистан или
            законом, для осуществления возложенных законодательством Республики
            Узбекистан на оператора функций, полномочий и обязанностей.
        </p>
        <p>
            ...
            законодательством Республики Узбекистан об исполнительном
            производстве.
        </p>
        <p>
        ...
        <p>
            ...
            персональных данных либо по его просьбе (далее &ndash; общедоступные
            персональные данные).
        </p>
        <p>
        ...
        <p>
            ...
            интересах, определенных законодательством Республики Узбекистан.
        </p>
        <p>
        ...
        <img alt="" class="pr-image" src="@/assets/img/p1.jpg" />
        <img alt="" class="pr-image" src="@/assets/img/p2.jpg" />
    </div>
</template>
